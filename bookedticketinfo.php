		...
		<?php
			...
			if(mysqli_num_rows($row)>0)
			{
				...
				while($r = mysqli_fetch_assoc($row))
				{
					?>
							<tr>
								<td style='padding: 10px; border: solid;'> <?php echo $i; ?> </td>

								<td style='padding: 10px; border: solid;'> <?php echo $r['First_Name']; ?> </td>

								<td style='padding: 10px; border: solid;'> <?php echo $r['Last_Name']; ?> </td>

								<td style='padding: 10px; border: solid;'> <?php echo $r['Email_ID']; ?> </td>

								<td style='padding: 10px; border: solid;'> <?php echo $r['Phone_No']; ?> </td>

								<td style='padding: 10px; border: solid;'> <?php echo $r['Seats']; ?> </td>
							</tr>
			...
			<table align="right">
				...
				<tr>
					<form action="adminsearch.php">
						...
						<td style="padding-right: 40px;"> <a href='adminallevent.php' class="link11"> Back </a> </td>
